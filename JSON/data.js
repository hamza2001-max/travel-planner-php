// import value from "../staticModels/"
export const destinationArray = [
    {
        id: 0, name: "Malaysia", image: "./staticModels/malaysia.jpg",
        landmarks: [{
            id: 0,
            name: "Redang Island",
            landmarkImage: "./staticModels/malaysiaIsland.jpg",
            description: "Redang Island is an island."
        },
        {
            id: 1,
            name: "Petronas Towers",
            landmarkImage: "./staticModels/malaysiaTower.jpg",
            description: "pt is an island."
        },
        {
            id: 2,
            name: "Sultan Masjid",
            landmarkImage: "./staticModels/malaysiaMasjid.jpg",
            description: "sm is an island."
        },
        {
            id: 3,
            name: "Royal Park",
            landmarkImage: "./staticModels/malaysiaWaterfall.jpg",
            description: "rp is an island."
        }]
        , price: 572,
    ...
    // {
    //     id: 1, name: "Russia", image: "./staticModels/russia.jpg", landmarks: [{
    //         name: "Redang Island",
    //         landmarkImage: "./staticModels/malaysiaIsland.jpg"
    //     },
    //     {
